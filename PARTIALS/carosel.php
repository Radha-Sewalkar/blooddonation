...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="/reddrop/pictures/f_2.jpg" class="d-block w-100 pic_size zoom cover_image" alt="...">
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="/reddrop/pictures/f_3.jpg" class="d-block w-100 pic_size zoom cover_image" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <?php
        if(!isset($_SESSION['C_loggedin']) || $_SESSION['C_loggedin'] != true)
        {echo '<a href="/reddrop/php/registration.php"><button class="btn btn-success mx-1 rounded-pill" type="button">Registration</button></a>
    ...
    <div class="carousel-item">
      <img src="/reddrop/pictures/f_1.jpg" class="d-block w-100 pic_size zoom cover_image" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <?php
        if(!isset($_SESSION['C_loggedin']) || $_SESSION['C_loggedin'] != true)
        {echo '<a href="/reddrop/php/registration.php"><button class="btn btn-success mx-1 rounded-pill" type="button">Registration</button></a>
