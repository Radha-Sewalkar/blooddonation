...
if (isset($_POST['submit'])) {
    ...
    Wrong Password - check  Username or Password again.
...
<body>
    ...
    <div class="d-flex justify-content-end">
        <a href="/reddrop/index.php" class="m-3 p-1 coral1">Home</a>
    </div>
    ...
    <div class="pin my-3 justify-content-center align-items-center ">
        <div class="py-5 px-5 border border-primary container1 l_box text-light text-center">
            <!-- <div class="text-center mb-3">
                <img src="/reddrop/INVENTORY_SHEET/pictures/Adm.png" id="box" class="img-fluid" alt="LOGO" width="200" height="50">
            </div> -->
